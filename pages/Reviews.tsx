            ...
            <div className="py-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-14">
                        <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Latest Google Reviews</h2>
                        <p className="text-gray-500 max-w-2xl mx-auto text-lg">
                            Direct feedback from our clients on Google Maps. We're proud of our 4.8-star reputation.
                        </p>
                        {isLive && (
